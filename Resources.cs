...
public class Resources
{
    ...
    public bool DisconnectPCSX2()
    {
        ...
        else if (!pcsx2running)
        {
            return false;
        }
        return false;
    }
    public MemorySharp SetM()
    {
        return m = new MemorySharp(Process.GetProcessesByName(PCSX2PROCESS).FirstOrDefault());
    }
    public bool TestR()
    {
        try
    ...
    public void ResetEE(int PCSX2Version)
    {
        ...
        switch (PCSX2Version)
        {
            case 1: EE = 0x277D60; address = SetM().Modules.MainModule.BaseAddress + EE; m.Assembly.Execute(address); break; //1.5 pcsx2dis
            case 2: EE = 0x265570; address = SetM().Modules.MainModule.BaseAddress + EE; m.Assembly.Execute(address); break; //1.6 pcsx2
            case 3: EE = 0xAFD6078; address = SetM().Modules.MainModule.BaseAddress + EE; break; //1.7 pcsx2
        }
    }
    ...
    public class Cheat
    {
        ...
        public Helpers.CheatType CheatType { get; set; }
        ...
        public static CheatBlock Parse(string block)
        {
            ...
            foreach (Match match in cheatMatches)
            {
                ...
                cheatBlock.Cheats.Add(new Cheat()
                {
                    ...
                    CheatType = (Helpers.CheatType)Convert.ToInt32(address.Substring(0, 2), 16),
                    Data = data
                });
    ...
    public class CheatEngine
    {
        ...
        public int ApplyCheat(CheatBlock cheatBlock, Cheat cheat)
        {
            ...
            {
                case Helpers.CheatType._8BitWrite:
                    return _8BitWrite(cheat);
                case Helpers.CheatType._16BitWrite:
                    return _16BitWrite(cheat);
                case Helpers.CheatType._32BitWrite:
                    return _32BitWrite(cheat);
                case Helpers.CheatType._copyBytes:
                    return CopyBytes(cheatBlock, cheat);
                case Helpers.CheatType._pointerWrite:
                    return PointerWrite(cheatBlock, cheat);
                case Helpers.CheatType._timer:
                    return Timer(cheatBlock, cheat);
                case Helpers.CheatType._32BitCondition:
                    return _32BitCondition(cheatBlock, cheat);
                case Helpers.CheatType._16BitCondition:
        ...
        public int Timer(CheatBlock cheatBlock, Cheat cheat)
        {
            ...
            if (cheatTimer == null)
            {
                ...
                Helpers.CheatTimerIntervalType timerIntervalType = (Helpers.CheatTimerIntervalType)BitConverter.ToInt32(bytes, 0);
    ...
    public class CheatTimer
    {
        ...
        private Helpers.CheatTimerIntervalType _cheatTimerIntervalType { get; set; }
        private DateTime _intervalDateTime { get; set; }
        private DateTime _currentDateTime { get; set; }
        private int _interval { get; set; }

        public CheatTimer(Cheat cheat, Helpers.CheatTimerIntervalType cheatTimerIntervalType, int interval)
        {
            Cheat = cheat;
            _interval = interval;
        ...
        public void SetCheatTimer()
        {
            ...
            {
                case Helpers.CheatTimerIntervalType.Ticks:
                    _intervalDateTime = _currentDateTime.AddTicks(_interval);
                    break;
                case Helpers.CheatTimerIntervalType.Seconds:
                    _intervalDateTime = _currentDateTime.AddSeconds(_interval);
                    break;
                case Helpers.CheatTimerIntervalType.Minutes:
