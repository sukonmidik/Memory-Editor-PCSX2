...
namespace MemEdit
{
    ...
    {  
        ...
        private Resources t = new Resources();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (t.ConnectPCSX2())
            {
                ...
                x = new Resources.CheatEngine(z, t.SetM(t.PCSX2PROCESS), 0x20000000);
                ...
                try
                {
                    ...
                    {
                        x.PatchMemory(l);
                        t.ResetEE(Resources.PCSX2Version);
                        timer2.Start();
        ...
        {
            MessageBox.Show("v1.7 is currently unsupported", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            pCSX2Dis15ToolStripMenuItem.Checked = false;
            pCSX216ToolStripMenuItem.Checked = false;
            pCSX217ToolStripMenuItem.Checked = false;
            return;
        ...
        {
            if (l != null && x != null && t.SetM(t.PCSX2PROCESS) != null)
            {
                try
                {
                    if (t.TestR())
